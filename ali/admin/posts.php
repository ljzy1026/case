    ...
    <div class="container-fluid">
      ...
      <div class="page-action">
        ...
        <ul class="pagination pagination-sm pull-right">
          <li><a href="?page=<?php echo $lpage. $search ?>" style="display: <?php echo $lpage < 1 ? 'none' :'block'; ?>">上一页</a></li>
          <?php for ($i = $begin; $i <= $end; $i++): ?>
          <li<?php echo $i === $page ? ' class="active"' : '' ?>><a href="?page=<?php echo $i . $search; ?>"><?php echo $i; ?></a></li>
          <?php endfor ?>
          <li><a href="?page=<?php echo $rpage. $search ?>" style="display: <?php echo $rpage > $end ? 'none' :'block'; ?>">下一页</a></li>
        </ul>
      </div>
